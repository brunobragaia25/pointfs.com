...
function PhotoFrame({ src, alt }: { src: string; alt: string }) {
  return (
    <div className="w-full h-[350px] md:w-[610px] md:h-[480px] rounded-[20px] p-3 bg-white shadow-[0px_0px_53.2px_0px_rgba(0,0,0,0.15)]">
    ...
    <>
      ...
      <section className="bg-white">
        ...
        >
          ...
          <motion.div className="flex flex-col gap-6 flex-1 min-w-0 items-center md:items-start" variants={stagger}>
            <motion.h2
              className="text-[28px] md:text-[48px] font-semibold text-[#03395B] leading-tight text-center md:text-left"
              variants={fadeUp}
            >
              Drive your Business Forward – FAST.
            </motion.h2>
            <motion.p
              className="text-[16px] md:text-[24px] text-[#444] leading-[1.75] text-center md:text-left"
              variants={fadeUp}
            >
            ...
            <motion.div variants={fadeUp}>
              <Link
                ...
                className="w-full md:w-auto flex items-center justify-center gap-2.5 border border-[#949494] rounded-lg px-3.5 py-3 text-sm font-medium text-[#444] hover:border-[#CCCCCC] transition-colors"
              >
      ...
      <section className="bg-white">
        <motion.div
          ...
          viewport={{ once: true, margin: "-80px" }}
        >
          <motion.div className="flex flex-col gap-6 flex-1 min-w-0 w-full order-2 md:order-1 items-center md:items-start" variants={stagger}>
            <motion.p
              className="text-[16px] md:text-[24px] text-[#444] leading-[1.75] text-center md:text-left"
              variants={fadeUp}
            >
          ...
          <motion.div variants={fadeUp} className="w-full md:w-auto md:flex-shrink-0 order-1 md:order-2">
