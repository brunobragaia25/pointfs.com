      ...
      html: `
        <div style="font-family: Inter, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: #032E5B; padding: 32px 40px; border-radius: 12px 12px 0 0;">
            <h1 style="color: #ED7426; font-size: 22px; font-weight: 700; margin: 0 0 4px 0;">New Carrier Partner Request</h1>
          ...
          <div style="background: #ffffff; padding: 32px 40px;">
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                ...
                <td style="padding: 10px 0; border-bottom: 1px solid #f0f0f0;">
                  <span style="font-size: 15px; color: #032E5B; font-weight: 500;">${fullName}</span>
                </td>
              </tr>
              <tr>
                <td style="padding: 10px 0; border-bottom: 1px solid #f0f0f0;">
              ...
              <tr>
                <td style="padding: 10px 0; border-bottom: 1px solid #f0f0f0;">
                  <span style="font-size: 12px; font-weight: 600; color: #888; text-transform: uppercase; letter-spacing: 0.05em;">Organization</span>
                </td>
                <td style="padding: 10px 0; border-bottom: 1px solid #f0f0f0;">
                  <span style="font-size: 15px; color: #032E5B;">${organization}</span>
                </td>
              </tr>` : ""}
            </table>
            ...
            <div style="margin-top: 24px;">
              <p style="font-size: 12px; font-weight: 600; color: #888; text-transform: uppercase; letter-spacing: 0.05em; margin: 0 0 8px 0;">Message</p>
        ...
        <div style="font-family: Inter, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background: #ffffff; padding: 32px 40px; border-radius: 0 0 12px 12px;">
            <p style="font-size: 16px; color: #444; line-height: 1.6; margin: 0 0 16px 0;">
              We've received your carrier partner request. Our team will reach out within <strong>24 hours</strong> to discuss next steps.
            </p>
